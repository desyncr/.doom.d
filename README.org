...
- [[#keybindings][Keybindings]]
  ...
  - [[#increasedecrease-window-width][Increase/decrease window width]]
...
- [[#coding][Coding]]
  ...
  - [[#centered-cursor-mode-1][centered-cursor-mode]]
...
Resize-window package actually supports a transient.el-like flow (it's older than transient.el though) where after invoking the command ~M-x resize-window~ you can add a series of commands and apply them: make vertial window larget, create new split etc.
