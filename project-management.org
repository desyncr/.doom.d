...
(defun run-command-recipe-example ()
  (list
   ...
   (list :command-name "org-tangle-doom"
         :command-line "cd ~/.doom.d && ~/.emacs.d/bin/org-tangle coding.org fonts.org general.org keybindings.org org-everything.org other.org packages.org project-management.org ui.org version-control.org writing.org"
         :display "Tangle Doom Emacs configuration")
  ))
...
#+begin_src emacs-lisp
(defun org-tangle-doom ()
  "Tangle Doom Emacs configuration."
  (interactive)
(call-process-shell-command "cd ~/.doom.d && ~/.emacs.d/bin/org-tangle coding.org fonts.org general.org keybindings.org org-everything.org other.org packages.org project-management.org ui.org version-control.org writing.org" nil "*Org-babel output*" t))
#+end_src
...
#+begin_src emacs-lisp
(setq bookmark-file "~/.doom.d/bookmarks.el")
#+end_src
