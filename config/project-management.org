...
(defun run-command-recipe-example ()
  (list
   ...
   (list :command-name "org-tangle-doom"
         :command-line "cd ~/.config/doom && ~/.emacs.d/bin/org-tangle coding.org fonts.org general.org keybindings.org org-everything.org other.org packages.org project-management.org ui.org version-control.org writing.org"
...
(defun org-tangle-doom ()
  ...
  (interactive)
(call-process-shell-command "cd ~/.config/doom && ~/.emacs.d/bin/org-tangle coding.org fonts.org general.org keybindings.org org-everything.org other.org packages.org project-management.org ui.org version-control.org writing.org" nil "*Org-babel output*" t))
#+end_src
