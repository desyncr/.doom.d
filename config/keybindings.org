...
#+begin_example
{
 ...
 [
   ...
   {:des "Control quote to quote" :rules [[{:key :quote :modi :control} {:key :quote}]]}
   {:des "Shift quote to double-quote" :rules [[{:key :quote :modi [:left_shift]} {:key :quote :modi :left_shift}]]}
