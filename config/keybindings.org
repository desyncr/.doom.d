...
#+begin_example
{
 ...
 [
   ...
   {:des "Control semicolon to semicolon" :rules [[{:key :semicolon :modi :control} {:key :semicolon}]]}
   {:des "Shift semicolon to colon" :rules [[{:key :semicolon :modi [:left_shift]} {:key :semicolon :modi :left_shift}]]}

   ;; mad scientist mode - delete
   {:des "Open bracket to delete" :rules [[{:key :open_bracket} :delete_or_backspace]]}
   {:des "Control open bracket to open bracket" :rules [[{:key :open_bracket :modi :control} :open_bracket]]}
   {:des "Shift open bracket to open bracket" :rules [[{:key :open_bracket :modi [:left_shift]} {:key :open_bracket :modi :left_shift}]]}
