...
[[kbd:][SPC n s]] search contents in ~org-directory~ by default. I've separated work from personal notes so I have a "personal" org directory and a "work" one. Since ~org~ only allows a single ~org-directory~ I created the functions down below to quickly switch between org directories.

#+begin_src emacs-lisp
(defun me/org-directory-personal ()
  (interactive)
  (setq org-directory "~/Personal/"))
(defun me/org-directory-work ()
  (interactive)
...
#+begin_src emacs-lisp
(defun me/org-agenda-view (type &optional notebook arg)
  (interactive "P")
  (if (eql notebook 'work) (setq org-agenda-files '("~/Work"))
    (setq org-agenda-files '("~/Personal")))
  (org-agenda arg type))

(map! :leader :desc "Work view" "o a w" (lambda() (interactive) (me/org-agenda-view "w" 'work)))
...
(use-package org-roam
  ...
  (setq org-roam-index-file "~/Personal/roam/index.org")
  )
#+end_src
...
(after! org
    ...
    (setq org-tag-alist '(("personal" . ?p) ("projects" . ?P) ("emacs" . ?e) ("learning" . ?l) ("@home" . ?h) ("work" . ?w) ("@computer" . ?c) ("errands" . ?E))))
#+end_src
...
* Config TODOs
#+begin_src emacs-lisp
(defun me/org-doom-config-todo (&optional arg)
  (interactive "P")
  (setq org-agenda-files '("~/.config/doom/config"))
  (org-todo-list arg)
  (setq org-agenda-files '("~/Personal")))
#+end_src
