...
(defun me/org-agenda-view (type &optional arg)
  (interactive "P")
  (setq org-agenda-files '("~/Personal" "~/Personal/notes"))
  ;; special case for agenda view which depends on project
  (pcase (projectile-project-name)
      ("Work" (setq org-agenda-files '("~/Work" "~/Work/notes"))))
  (pcase type
         ("w" (setq org-agenda-files '("~/Work" "~/Work/notes")) (org-todo-list))
...
(map! "M-o" (lambda() (interactive) (me/org-agenda-view "a")))
#+end_src
...
(after! org
    ...
    (setq org-tag-alist '(("personal" . ?p) ("projects" . ?P) ("finance" . ?f) ("emacs" . ?e) ("learning" . ?l) ("@home" . ?h) ("work" . ?w) ("@computer" . ?c) ("errands" . ?E))))
#+end_src
