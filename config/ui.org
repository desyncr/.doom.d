...
(setq display-buffer-alist '(
   ...
   ("\\*Org Agenda\\*"
    ...
    (side . right) (slot . 0) (window-width . 0.3))
   ("\\*Org todo\\*"
    display-buffer-in-side-window
    (side . right) (slot . 0) (window-width . 0.3))
   ;; Bottom
   ("\\*Agenda Commands\\*"
    ...
    (side . bottom) (slot . 0) (window-width . 0.3))
   ("^\\*Search.*"
    (+popup-buffer) (actions)
    (side . bottom) (slot . -5) (window-width . 0.3))
   ...
   ("^\\*helpful.*"
    display-buffer-in-side-window
    (side . bottom) (slot . 1) (window-width . 0.3))
   ;; Hide windows
